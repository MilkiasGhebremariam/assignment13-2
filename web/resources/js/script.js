...
function addToCart(clicked_id) {
    ...
    var item = {id: id,
        ...
        price: siblings[3].innerText.split(":")[1].trim(),
...
$(function () {
    ...
    function addProduct(data) {
        ...
        var addtocart = $("<button>").addClass("btn btn-info").attr("id",data.id).attr("onclick", "addToCart(this.id)").text("Order Now ");
