...
//        }
        ...
        HashMap<String,User> li=usersDAO.getMap();


        for (Map.Entry<String,User>l:li.entrySet()) {



            if (l.getValue().getUsername().equals(userName) && l.getValue().getPassword().equals(password)){
            //if (l.get(userName).getUsername().equals(userName) && li.get(userName).getPassword().equals(password)) {
                flag = true;
                break;
